...
- Inventory Valuation (Moving-Average Cost)
  - tblfn-trade-result
  - tblfn-trade--add-cost
  - tblfn-trade--add-quantity
  - tblfn-trade--compute-profit
  - tblfn-trade--compute-average-cost
  - tblfn-trade--add-profit
  - tblfn-trade--sub-quantity
  - tblfn-trade--divide-cost
  - tblfn-trade--convert-result
...
- Calc Integration
  ...
  - tblfn-calcopt-parse
  - tblfn-calc-eval
  - tblfn-string-to-math-number
  - tblfn-to-math-number
  - tblfn-math-number-to-decimal-string
...
- Anything other than a list (nil or cons cell), including the ~hline~ symbol
